...
async def button_callback(
    ...
    # ---- Deposit: coin selected ----
        ...
        try:
            ...
            pay_currency = inv.get("payCurrency") if isinstance(inv.get("payCurrency"), dict) else {}
            address = (
                inv.get("address")
                or inv.get("pay_address")
                or pay_currency.get("address", "")
            )
            network = inv.get("network") or inv.get("pay_network") or ""
